...
const Footer = () => {
  ...
  const sitePhone = settingsData?.data?.settings?.site_phone || "+1 (800) 555-AUTO";
  const siteEmail = settingsData?.data?.settings?.site_mail || "support@autoelite.com";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="mt-4 space-y-1">
              <p className="text-sm text-muted-foreground">{sitePhone}</p>
              <p className="text-sm text-muted-foreground">{siteEmail}</p>
            </div>
          </div>
